...
Чтобы скачать данный проект вам нужно кликнуть по зеленой плашке с надписью код, далее нажать на кнопку 'download zip', затем распаковать архив и кликнуть по одному из файлов с препиской .py. Использовать можно в любой среде программирование на языке Python.
